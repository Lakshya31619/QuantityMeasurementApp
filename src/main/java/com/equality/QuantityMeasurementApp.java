...
public class QuantityMeasurementApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("  Base units: %.2f + %.2f %n", 
            feet5.toBaseUnit(), inches24.toBaseUnit(), ArithmeticOperation.ADD);
        System.out.printf("  Result: %s%n", feet5.add(inches24));
        
        System.out.printf("  Base units: %.2f - %.2f %n", 
            feet5.toBaseUnit(), inches24.toBaseUnit(), ArithmeticOperation.SUBTRACT);
        System.out.printf("  Result: %s%n", feet5.subtract(inches24));
        
        System.out.printf("  Base units: %.2f / %.2f %n", 
            inches24.toBaseUnit(), feet5.toBaseUnit(), ArithmeticOperation.DIVIDE);
        ...
        System.out.printf("  Base units: %.2f + %.2f %n", 
            kg3.toBaseUnit(), g500.toBaseUnit(), ArithmeticOperation.ADD);
        System.out.printf("  Result: %s%n", kg3.add(g500));
        
        System.out.printf("  Base units: %.2f - %.2f %n", 
            kg3.toBaseUnit(), g500.toBaseUnit(), ArithmeticOperation.SUBTRACT);
        System.out.printf("  Result: %s%n", kg3.subtract(g500));
        
        System.out.printf("  Base units: %.2f / %.2f %n", 
            kg3.toBaseUnit(), g500.toBaseUnit(), ArithmeticOperation.DIVIDE);
        ...
        System.out.printf("  Base units: %.2f + %.2f %n", 
            litre2.toBaseUnit(), ml500.toBaseUnit(), ArithmeticOperation.ADD);
        System.out.printf("  Result: %s%n", litre2.add(ml500));
        
        System.out.printf("  Base units: %.2f - %.2f %n", 
            litre2.toBaseUnit(), ml500.toBaseUnit(), ArithmeticOperation.SUBTRACT);
        System.out.printf("  Result: %s%n", litre2.subtract(ml500));
        
        System.out.printf("  Base units: %.2f / %.2f %n", 
            litre2.toBaseUnit(), ml500.toBaseUnit(), ArithmeticOperation.DIVIDE);
